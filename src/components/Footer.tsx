        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <address className="not-italic">
              <p className="mb-2">123 Book Street, Tehran, Iran</p>
              <p className="mb-2">Email: info@bookshop.com</p>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" className="hover:text-blue-300 transition-colors" aria-label="Telegram">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
